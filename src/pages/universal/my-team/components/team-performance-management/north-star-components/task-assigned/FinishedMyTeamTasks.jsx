...
const FinishedMyTeamTasks = ({
  ...
  const handleOpenModal = async (event, id) => {
    //document.getElementById("team_finished_task_notes").showModal();
  ...
  return (
    <>
      ...
      <dialog id="team_finished_task_notes" className="modal">
        <div className="modal-box p-0 flex flex-col justify-between h-full">
          <div className="border-b border-[#e4e4e4] p-5">
            ...
            <button
              ...
              onClick={() =>
                document.getElementById("team_finished_task_notes").close()
              }
            >
              ✕
            </button>
...
export default FinishedMyTeamTasks;
