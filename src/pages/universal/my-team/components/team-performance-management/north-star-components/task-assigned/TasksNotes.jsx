...
const TaskNotes = () => {
    ...
    return (
        <>
            <div
                className="w-full"
                onClick={() => document.getElementById("task_notes").showModal()}
            >
            ...
            <dialog id="task_notes" className="modal">
                <div className="modal-box">
                    ...
                    <button className="btn btn-sm btn-circle btn-ghost absolute right-5 top-5" onClick={handleCloseNote}>
                        ✕
                    </button>
                    <form
                        id="taskNotesForm"
                    ...
                    >
                        <div className="label mt-1">
                            <p className="label-text flex-col text-[12px] justify-start text-justify text-wrap">
                                This is a space for sharing task notes for the assignor and the assignee. Add messages, list more information, expound more details about the task, or keep links and files handy. You can also talk to yourself here, but please keep in mind that both you and the other party can access these notes.
                            </p>
                            <br/>
                        </div>
                        <div className="divider mt-3 mb-3 rounded-[15px] border-[#D1D5DB]">
                            <span className="md:text-[10px]">July 01, 2024</span>
                        </div>
                        <div className="box-border bg-[#f4f4f4] flex flex-col gap-3 p-3 rounded-[15px]">
                            <div className="flex items-start gap-3 w-full">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-wrap mt-2">Hi Marvin! just received the task, are there any other things I need to take note of.</p>
                                </div>
                            </div>
                        </div>
                        <div className="divider mt-3 mb-3 rounded-[15px] border-[#D1D5DB]">
                            <span className="md:text-[10px]">Today</span>
                        </div>
                        <div className="box-border bg-[#f4f4f4] flex flex-col gap-3 p-3 rounded-[15px]">
                            <div className="flex items-start gap-3 w-full">
                                <div className="box box-border w-[50px] h-[50px] flex justify-center items-center rounded-full bg-[#CC5500]"> 
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-wrap mt-2">
                                        Can you please get this done as soon as possible. 
                                        <br/><br/>
                                        Here are some things that you can add:
                                        <ul className="list-disc list-inside">
                                            <li>Employee Number</li>
                                            <li>Date Application</li>
                        ...
                        <div className="box box-border flex flex-row gap-3 mt-10">
                            ...
                            ></textarea>
                            <button className="btn bg-[#666a40] text-white" onClick={handleCloseNote}>
                                <svg
