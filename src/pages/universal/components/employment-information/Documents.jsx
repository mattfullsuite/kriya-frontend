...
const Documents = () => {
  ...
  return (
    <div className="box-border bg-white p-5 border border-[#e4e4e4] rounded-[15px] overflow-x-auto">
      <table className="table">
        ...
        <tbody>
          <tr>
            ...
            <td className="text-[12px] text-[#363636]">February 28, 2024</td>
            <td className="text-[12px] text-[#363636]">Word Document</td>
            <td className="text-[10px] text-[#363636]">
              <button
                className={`text-[12px] font-semibold ${theme.accentColor} ${theme.textColor} px-3 py-2 rounded-[8px]`}
              >
                View
              </button>
            </td>
          ...
          <tr>
            <td className="flex flex-row flex-nowrap justify-start items-center gap-2">
              ...
              <span className="text-[12px] text-[#363636]">Welcome Packet</span>
            </td>
            <td className="text-[12px] text-[#363636]">February 28, 2024</td>
            <td className="text-[12px] text-[#363636]">Word Document</td>
            <td className="text-[10px] text-[#363636]">
