...
const MyRecentCheerTiles = () => {
  return (
    <div className="bg-[#f0f0f0] p-3 rounded-[8px] flex flex-row justify-between items-center">
      ...
      <Link to={`/hr/my-pulse/cheer-a-peer/all-cheers/view-post/5`}>
        <button className="text-[11px] text-[#666a40] bg-[#D8D8D0] py-1 px-2 rounded-[5px]">
          Details
        </button>
      </Link>
    </div>
...
export default MyRecentCheerTiles;
