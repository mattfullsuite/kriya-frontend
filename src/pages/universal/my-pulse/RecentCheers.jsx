...
const RecentCheers = ({
  ...
  return (
    <div className="m-auto max-w-[1300px]">
        ...
        <Link to={`/hr/my-pulse/cheer-a-peer/all-cheers`}>
          <div className="flex flex-row justify-start items-center gap-[2px]">
            <svg
              ...
              viewBox="0 0 24 24"
              className="w-6 h-6 fill-[#666a40]"
            >
              <path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z"></path>
            </svg>

            <span className="text-[#666a40] text-[14px]">BACK</span>
          </div>
        </Link>
      ...
      <div className="max-w-[700px] flex flex-col gap-5 m-auto mt-5">
        <div className="flex flex-row justify-between gap-3">
          <input
            className="flex-1 outline-none py-2 px-3 border border-[#e4e4e4] rounded-[8px] text-[14px] text-[#363636]"
            placeholder="Search employee..."
          />

          <select className="w-28 outline-none py-2 px-3 border border-[#e4e4e4] rounded-[8px] text-[14px] text-[#363636]">
