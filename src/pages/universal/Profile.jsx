    ...
    <>
      ...
      {profile.map((p) => (
        <div className="flex flex-col max-w-[1300px] m-auto">
          ...
          <div className="mt-5 border border-[#e4e4e4] rounded-[15px] bg-white flex flex-1 flex-col p-5">
          ...
          <div className="mt-5 border border-[#e4e4e4] rounded-[15px] bg-white flex flex-1 flex-col p-5 overflow-x-auto">
