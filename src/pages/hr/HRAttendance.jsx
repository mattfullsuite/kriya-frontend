            ...
            <div className="box-border w-full xl:w-72 flex flex-col justify-start gap-2">
              <div className="box-border bg-white p-3 rounded-[15px] border border-[#e4e4e4]">
                <div className="flex flex-row justify-start gap-1">
                  ...
                  <span className="text-[14px] font-semibold text-[#90946f]">
                    My Total PTO Days
                  </span>
                </div>
                ...
                <div className="box-border rounded-full w-9 h-9 bg-[#90946f] flex justify-center items-center">
                  <button
