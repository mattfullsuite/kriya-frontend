...
const ViewDispute = ({
  ...
  useEffect(() => {
    axios
      .get(BASE_URL + "/d-get-requester-past-disputes/" + empID)
      .then((response) => {
    ...
    axios
      .get(BASE_URL + "/d-get-requester-disputes/" + empID)
      .then((response) => {
  ...
  const handleRemove = (disputeID, status) => {
    const updatedDispute = disputes.filter((item) => item.dispute_id === disputeID)[0];
