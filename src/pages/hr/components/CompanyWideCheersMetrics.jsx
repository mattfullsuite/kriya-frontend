...
const CompanyWideCheersMetrics = () => {
  return (
    <div className="box-border bg-white p-5 border border-[#e4e4e4] rounded-[15px] flex flex-col justify-between">
      <div className="box-border flex-1">
        <div className="box-border flex flex-row justify-between items-center">
          <Subheadings text={"Company-wide Cheers Metrics"} />
          ...
          <table className="table">
            <thead>
              <tr>
                ...
                <th className="text-[#666A40] font-medium">Cheers Given</th>
                <th className="text-[#666A40] font-medium">Cheers Received</th>
              </tr>
            </thead>
...
export default CompanyWideCheersMetrics;
