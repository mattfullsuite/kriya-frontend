    ...
    <div className="box-border bg-white p-5 border border-[#e4e4e4] rounded-[15px] flex flex-col justify-between">
              ...
              <tr>
                ...
                <td className="flex-1">
                  <div className="text-center flex flex-col justify-center">
                    <p className="text-[24px] text-[#CC5500] font-bold leading-none">
                      49
                    </p>
                    <p className="text-[10px] text-[#CC5500] leading-none">
                      Given
                    </p>
                  </div>
                </td>
                ...
                <td className="flex-1">
                  <div className="text-center flex flex-col justify-center">
                    <p className="text-[24px] text-[#FFAE36] font-bold leading-none">
                      42
                    </p>
                    <p className="text-[10px] text-[#FFAE36] leading-none">
                      Received
                    </p>
                  </div>
                </td>
      ...
      <div className="box-border border-t border-[#e4e4e4] mt-5">
        ...
        <div className="box-border flex flex-col gap-2">
          <InsightsListTile
            notif={"Employee Cheers Metric Insights 1"}
            content={
          ...
          <InsightsListTile
            notif={"Employee Cheers Metric Insights 2"}
            content={
              "Overview of insights with a detailed examination and discussion of the Pulse Metrics of the Employee"
            }
            suggestion={"Suggestion here"}
...
export default DepartmentCheersMetrics;
