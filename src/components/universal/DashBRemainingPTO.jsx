  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        ptos.map((pto) => (
          <div className="m-2 p-4 border-2 border-gray-200 border-solid bg-white rounded-lg dark:border-gray-700 flex flex-1 flex-col items-center justify-between text-center md:w-56 h-56">
            <h1 className="text-xl font-semibold text-left w-full">
              PTO Points
            </h1>
