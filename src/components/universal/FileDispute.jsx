...
const FileDispute = () => {
  ...
  const handleChange = (event) => {
    ...
    console.log(JSON.stringify(disputeInfo));
  ...
  const handleCancel = () => {
    document.getElementById("file_a_dispute_btn").close();
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(BASE_URL + "/fileOvertime", disputeInfo)
      .then((res) => {
        if (res.data === "success") {
          document.getElementById("file_a_dispute_btn").close();
          document.getElementById("disputeForm").reset();
    ...
    <>
      ...
      <div className="m-2 flex flex-col">
        <div
          ...
          onClick={() =>
            document.getElementById("file_a_dispute_btn").showModal()
          }
        >
        ...
        <dialog id="file_a_dispute_btn" className="modal">
            ...
            >
              ...
              <label>
                ...
                >
                  ...
                  <option> Attendance Dispute </option>
                  <option> Attendance Dispute </option>
                </select>
              </label>
