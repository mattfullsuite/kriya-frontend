...
import NoRecord from "./sub-components/NoRecord.jsx";
      ...
      <div>
        ...
        <div className="flex flex-col border-2  border-[#E4E4E4] rounded-[15px] p-5 bg-white">
          <div className="flex flex-col lg:flex-row w-full">
            ...
            <div className="flex flex-col w-full lg:w-[35%] lg:pl-5">
        ...
        <div className="">
          ...
          <div className="border-2 border-[#E4E4E4] flex flex-row rounded-[15px] p-5 bg-white">
