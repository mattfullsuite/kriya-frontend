...
const RegularEmployee = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.loggedIn === true) {
          ...
          } else if (empRole.current === 2 || empRole.current === 4) {
  ...
  return (
          ...
          <div className="flex-1 no-scrollbar overflow-auto w-full flex flex-col flex-nowrap gap-3 pb-5">
            ...
            <div className="box-border hidden flex-col gap-3" ref={teamSubNav}>
              <NavLink to={"/regular/my-team/team-pto-and-attendance"}>
                {(isActive) => {
                  return isActive.isActive ? (
                    <span className="text-[#EC7E30] text-[14px] ml-[4.1rem]">
                      Team PTO & Attendance
                    </span>
                  ) : (
    ...
    //     <div className="no-scrollbar box-border w-72 bg-white max-h-screen overflow-auto fixed transition-all ease-in-out duration-300 -translate-x-72 md:translate-x-0 flex flex-col items-center z-50">
    //       <div className="box-border bg-gradient-to-br from-[#CC5500] to-[#FF974D] p-3 rounded-[15px] w-[85%] mt-5 drop-shadow-lg">
    //         <div className="box-border flex flex-row justify-start items-center gap-2">
    //           {profilePic === "" || profilePic === null ? (
    //             <div className="box-border w-[3rem] h-[3rem] bg-white rounded-full flex justify-center items-center">
    //               <span className="font-bold text-[#EC7E30]">
    ...
    //     <div className="box-border flex-1 md:ml-72 bg-[#F7F7F7] min-h-screen p-5">
    //       <Outlet />
    //     </div>
    //   </div>
    // </>
