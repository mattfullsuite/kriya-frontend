    ...
    <div className="drawer md:drawer-open">
      ...
      <div className="drawer-side">
        ...
        <div className="w-72 min-h-full bg-white flex flex-col items-center relative">
          <div className="group/card box-border bg-gradient-to-br from-[#a000b5] to-[#810191] p-3 rounded-[15px] w-[85%] mt-5 drop-shadow-lg">
            ...
            <p className="text-white text-[12px] mt-9">Payroll Accountant</p>
          </div>
          ...
          <div className="mt-10 w-full flex flex-col flex-nowrap gap-3">
            ...
            <NavLink to="/payrollaccountant/run-regular-payroll">
              {(isActive) => {
                return isActive.isActive ? (
                  <div className="flex flex-row justify-start items-center gap-8">
                    <div
            ...
            <NavLink to="/payrollaccountant/run-last-pay">
              {(isActive) => {
                return isActive.isActive ? (
                  <div className="flex flex-row justify-start items-center gap-8">
                    <div
            ...
            <NavLink to="/payrollaccountant/payroll-settings">
              {(isActive) => {
                return isActive.isActive ? (
                  <div className="flex flex-row justify-start items-center gap-8">
                    <div
            ...
            <NavLink to="/payrollaccountant/upload-a-pay-register">
              {(isActive) => {
                return isActive.isActive ? (
                  <div className="flex flex-row justify-start items-center gap-8">
                    <div
